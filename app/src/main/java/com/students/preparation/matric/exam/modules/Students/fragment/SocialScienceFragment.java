...
import com.students.preparation.matric.exam.adapter.SocialScienceAdapter;
...
import com.students.preparation.matric.exam.modules.Students.activities.SubjectsExamActivity;
...
public class SocialScienceFragment extends Fragment {
    ...
    private SocialScienceAdapter adapter;

    public SocialScienceFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =inflater.inflate(R.layout.fragment_social_science, container, false);

        databaseReference = FirebaseDatabase.getInstance().getReference(Constants.EXAM_FILES_PATH);

        adapter = new SocialScienceAdapter(this,getContext(),arrayList);
        ...
        final String[] subjectsArray = getResources().getStringArray(R.array.social_subjects);
